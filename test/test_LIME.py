...
class Test(TestCase):
    def test_load_images_from_paths(self):
        image_paths = ["./data/gtFine-seg/images/test/berlin/berlin_000000_000019_leftImg8bit.png",
                       "./data/gtFine-seg/images/test/berlin/berlin_000001_000019_leftImg8bit.png"]
